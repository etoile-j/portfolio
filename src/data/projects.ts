    ...
    highlights: [
        {
            ...
            그리고 화면이 활성화된 상태에서는 ��림을 보내지 않아 불필요한 알림을 최소화하였습니다.
        ...
        {
            title: "AWS EC2와 Nginx를 활용한 ���버 구축 및 네트워크 인프라 및 관리",
...
export const ourshop = {
    ...
    highlights: [
        ...
        },
        {
            ...
            description: `최근 서버가 종료되면서 서버가 응답하지 않을 경우
            사용자에게 보이는 화면에 대해 생각하게 되었습니다.
...
export const whobego = {
    ...
    highlights: [
        ...
        },
        {
            ...
            이렇게 불필요한 여러 번의 DOM 변경과 리플로우, 리페인트를
            한 번으로 줄여 렌더링 성능을 최적화하였습니다.
